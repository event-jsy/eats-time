# eats-time | JSP 프로젝트 : 유통기한 임박 식품 거래 서비스
...
## 🧑‍🤝‍🧑 맴버구성 - 백엔드 업무
 - 팀장  : 박유미 - 관리자페이지(회원 관리)
 - 부팀장 : 이종문 - 제품 목록 조회, 결제
 - 팀원1 : 김인진 - 구매자 마이페이지, 판매자 마이페이지
 - 팀원2 : 김치윤 - 관리자 페이지(공지사항), 공지사항 전체
 - 팀원3 : 문소영 - 관리자 페이지(문의내역), 구매자 마이페이지(문의하기)
 - 팀원4 : 이기철- 메인 페이지, 검색
 - 팀원5 : 조세연 - 로그인, 회원가입
 ...
 ## ✨ 목적 및 기대 효과
- 공급자 : 남는 재고를 판매함으로 인한 쓰레기 감소 효과
- 소비자 : 필요한 물품을 저렴한 가격에 사서 소비함으로 인한 경제적인 이익을 볼 수 있다.
